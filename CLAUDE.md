...
**Boot device identity** — the kernel is *given* its boot partition by the bootloader, never asked to find one. Selecting on a partition's *type*, or on "the first one of the right format", is the defect this exists to make unrepresentable.
