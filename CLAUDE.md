...
- **Gate A's fast tier reds intermittently, on `main` as much as on your branch.** Before believing it is yours, stash and re-run. `specs/issues/audio/`.
