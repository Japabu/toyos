...
- **Self-hosting.** The north star is building ToyOS from within ToyOS. No LLVM dependency. Cranelift as codegen backend — reaffirmed 2026-08-10 and priced in `specs/cranelift-backend-assessment.md`: cg_clif re-enters LLVM to assemble, and its code is 20× slower. Not a next step.
