...
- **Every CPU but the BSP runs with caching disabled**, and with `CR0.NE`, `CR0.WP` and `CR4.MCE` clear. Any per-CPU measurement on an AP is measuring an uncached machine.
