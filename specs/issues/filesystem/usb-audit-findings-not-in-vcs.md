...
What is not owed: F-K is recorded (`specs/plans/xhci-port-machine-plan.md`,
`with_storage`'s non-local invariant), F-E is the EP0 recovery path, and F-J —
the file-cache error channel — is closed.
