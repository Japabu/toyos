...
and the one `specs/xhci-port-machine-plan.md` X2c scopes.
...
`specs/iouring-blocking-spec.md` is the end state: one completion primitive, two
...
worst of `specs/metal-logs/2026-08-08-audio-wake/`, with `drains=0` and
`max_batch=1`.
