...
darwin/arm64 (`specs/plans/arm64-research-2026-07-28.md` §"Verified on this machine").
TCG's distortion is **non-uniform**, measured on this host:

| Operation | TCG (x86-64) vs native | Source |
|---|---|---|
| Address-space switch + TLB flush | 1619 ns vs 251 ns = **6.5x** | `specs/plans/arm64-research-2026-07-28.md` |
| Memory | **3.4x** | ibid. |
...
this tree (`specs/assessments/cpu-attribution.md`; `kernel/target/x86_64-unknown-none/` contains
...
2. **TCG distortion lands squarely on the wake path and is non-uniform.** Arming the
   ...
   (`specs/assessments/cpu-attribution.md`). The address-space switch is 6.5x. The ALU work in
...
3. **Re-prime on the next `MSG_STREAM_OPEN`.** This is the dangerous half, and our own
   ...
   `specs/assessments/audio-glitch-distribution-2026-07-28.md`), and PipeWire defaults
...
`specs/plans/arm64-research-2026-07-28.md`'s address-space switch + TLB flush: **1619 ns
...
- `specs/plans/arm64-research-2026-07-28.md` - TCG vs HVF microbenchmarks measured on this host.
- `specs/assessments/cpu-attribution.md` - the unoptimized-kernel finding and the TCG analysis.
- `specs/assessments/audio-glitch-distribution-2026-07-28.md` - the re-prime glitch mode.
