...
`specs/plans/metal-boot-plan.md`). This file records the strategy so it survives
...
5. **The instrument-defect lesson** (`specs/assessments/audio-gate-history.md`): the
