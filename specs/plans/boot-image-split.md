...
by the owner; `specs/plans/posix-bootstrap-cost.md` and the self-hosting north star
...
- **The four-way split of a boot's wall clock** on current `main`: firmware,
  ...
  2.48 s / 1.42 s / 0.93 s from `specs/plans/arm64-research-2026-07-28.md` §1, taken
