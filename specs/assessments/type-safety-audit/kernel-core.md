...
`specs/assessments/capability-handles-spec.md` §5 runs `on_zero_handles` off a deferred queue
...
**Relation to filed work.** `specs/assessments/capability-handles-spec.md` §6.5 deletes the
...
`specs/plans/iouring-blocking-spec.md` implies — it gets an error code silently treated
