...
recording, and `specs/assessments/audio-gate-history.md`'s reusable lesson is that these
...
`specs/assessments/audio-gate-history.md`'s standing lesson is that a verdict taken from one
