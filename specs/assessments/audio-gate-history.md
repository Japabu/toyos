...
`specs/assessments/audio-glitch-distribution-2026-07-28.md`.
...
(`specs/assessments/audio-glitch-distribution-2026-07-28.md` mode A). After the fix, 30
...
Both are in `issues/` and both are the reusable part:
