...
//! fds without ever blocking on a client, allocates and grants the shared
...
/// the loop never reaches the composite — a freeze with a different shape and
...
pub const FIXED_POLL_FDS: u32 = 3;
...
/// binds.
pub const MAX_WINDOW_SLOTS: u32 = Poller::MAX_HANDLES - FIXED_POLL_FDS - MAX_PENDING_CONNS;
