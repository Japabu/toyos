...
| `arch/` | 107 | **adopted 2026-08-22 — the last area, and the kernel is now gated whole.** 107 findings (112 `unsafe` blocks in all); **30 removed, 77 documented, 3 filed.** Per file below. |
