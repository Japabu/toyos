...
`desktop_window_child` is an expected failure (`issues/kernel/`) that runs its
...
itself, and the defect was in the kernel (`issues/diagnostics/`, closed 2026-08-08). `ALONE: GREEN`
