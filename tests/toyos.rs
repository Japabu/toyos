...
const MACHINE_TESTS: &[(&str, Sched, Tier)] = &[
    ...
    // §9.1's conservation law across `SYS_LOG_READ`, at the three widths, and
    // §9.2's nesting gate at one CPU. Parallel: every verdict is a ledger the
    ...
    ("log_conservation", Sched::Parallel, Tier::Fast),
...
fn run_machine_test(
    ...
    match name {
        ...
        "log_conservation" => common::logread::log_conservation(test_config, c_bins, rust_bins),
