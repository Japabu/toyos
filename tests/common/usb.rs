...
pub fn xhci_slow_connect(
    ...
    //
    // **This is the log architecture's own named boot instrument, and until
    // 2026-08-15 it could not be read off the test that
    // *is* it.** What it is for is an interleaved A/B of a producer-path
